...
def test_example(page: Page) -> None:
    ...
    page.get_by_text("Halfjaar").click()
    page.click("#volgende-stap")
    #Aanvullende verzekering
    page.click('button[value*="|AF1|Aanvullendproduct"]')
    page.click("#volgende-stap")
    ...
    page.locator("#Verzekerden_0__Achternaam_Value").fill("anderzorgautoeen")
    #functie voor BSN
    ...
    page.locator("#Verzekerden_0__Geboortedatum_Value_Month").fill("1")
    page.locator("#Verzekerden_0__Geboortedatum_Value_Year").fill("1975")
