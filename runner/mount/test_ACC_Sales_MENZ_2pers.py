...
from variables import AccMenzSalesUrl, TstMenzSalesUrl
...
def test_example(page: Page) -> None:
    ...
    page.click('button[value*="|MEV2|Aanvullendproduct"]')
    page.click("#volgende-stap")
    ...
    page.locator("#Verzekerden_0__Achternaam_Value").fill("menzisautotwee")
    #functie voor BSN
    ...
    page.locator("#Verzekerden_0__Geboortedatum_Value_Month").fill("3")
    page.locator("#Verzekerden_0__Geboortedatum_Value_Year").fill("1976")
    ...
    page.locator("#Verzekerden_1__Achternaam_Value").fill("menzisautotwee")
    ...
    page.locator("#Verzekerden_1__Geboortedatum_Value_Month").fill("2")
