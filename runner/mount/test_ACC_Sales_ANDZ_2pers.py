...
def test_example(page: Page) -> None:
    page.goto("https://www2.acc.anderzorg.nl/premie-berekenen-en-aanvragen")
    ...
    page.get_by_text("Kwartaal").click()
    page.click("#volgende-stap")
    #Aanvullende verzekering
    page.click('button[value*="|AEX|Aanvullendproduct"]')
    page.click("#volgende-stap")
    ...
    page.locator("#Verzekerden_0__Achternaam_Value").fill("anderzorgautotwee")
    #functie voor BSN
    ...
    page.locator("#Verzekerden_0__Geboortedatum_Value_Month").fill("2")
    page.locator("#Verzekerden_0__Geboortedatum_Value_Year").fill("1979")
    ...
    page.locator("#Verzekerden_1__Achternaam_Value").fill("anderzorgautotwee")
    ...
    page.locator("#Verzekerden_1__Geboortedatum_Value_Month").fill("1")
